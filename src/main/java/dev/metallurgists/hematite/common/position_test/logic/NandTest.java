...
public record NandTest(List<PositionTest> predicates) implements PositionTest {

    public static final MapCodec<NandTest> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            PositionTest.CODEC.listOf().fieldOf("predicates").forGetter(NandTest::predicates)
    ...
    public PositionTestType<?> getType() {
        return HematitePositionTestTypes.NAND.get();
    }
}
