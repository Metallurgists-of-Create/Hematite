...
public record NeighborCheck(RuleTest mustHavePredicate, RuleTest mustNotHavePredicate, Integer requiredAmount, List<Direction> directions) implements AreaCondition {
    ...
    public static NeighborCheck simple(RuleTest mustHave) {
        return new NeighborCheck(mustHave, AlwaysTrueTest.INSTANCE, 1, List.of(Direction.values()));
    }
    @Override
    public AreaConditionType<NeighborCheck> getType() {
        return HematiteAreaConditionTypes.NEIGHBOR_BASED_GENERATION.get();
    }
